    ...
    <>
      <Row>
        <Col md={6} xs={12}>
          ...
          <div>
            <div>
              <p> Hi Everyone, I am Nguyen Viet from Dak Lak, VietNam.</p>
              <p> I have two years to study in FPT University Ho Chi Minh.</p>
            </div>
          </div>
          <div>
                  ...
                  <div className="experience-container">
                    ...
                    <div className="details">
                      ...
                      <div className="info">
                        ...
                        <p className="company">
                          I have two years to study in FPT University Ho Chi
                          Minh.{" "}
                        </p>
                      </div>
                    </div>
